...
black_threshold = ((0, 0, 0), (180, 255, 60))
...
def black_mask(image, display_image):
    ...
    if len(contours) == 1:
        ...
        # Select contour closest to previoust
        ...
        # Now, remove all other contours except the one selected
        contours = [contour]  # This keeps only the selected contour
