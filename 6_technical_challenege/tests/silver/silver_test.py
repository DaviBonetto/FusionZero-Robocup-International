...
detector = SilverLineDetector('/home/aidan/FusionZero-Robocup-International/5_ai_training_data/0_models/silver_line/silver_detector_pi4_quantized.pt')
...
while True:
    ...
    # Get prediction
    result, image = detector.predict(image)
    show(image, name="Preprocess", display=True)
